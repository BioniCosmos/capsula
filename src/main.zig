...
pub extern fn xstring_new_with_size(size: usize) [*c]XString;
pub extern fn xstring_from(s: [*c]const u8) [*c]XString;
pub extern fn xstring_clone(xs: [*c]XString) [*c]XString;
pub extern fn xstring_drop(xs: [*c]XString) void;
pub extern fn xstring_to_c_string(xs: [*c]XString) [*c]const u8;
pub extern fn xstring_push(a: [*c]XString, b: [*c]XString) void;
pub extern fn xstring_concat(a: [*c]XString, b: [*c]XString) [*c]XString;
pub extern fn int_to_xstring(i: c_int) [*c]XString;
pub const None: c_int = 0;
pub const IndexOutOfRange: c_int = 1;
pub const ListError = c_uint;
...
pub extern fn list_new_with_capacity(capacity: usize) [*c]List;
pub extern fn list_new(...) [*c]List;
pub extern fn list_drop(list: [*c]List, drop_element: ?*const fn (?*anyopaque) callconv(.C) void) void;
pub extern fn list_insert(list: [*c]List, index: usize, element: ?*anyopaque) ListError;
pub extern fn list_push(list: [*c]List, element: ?*anyopaque) ListError;
pub extern fn list_get(list: [*c]List, index: usize) ?*anyopaque;
pub extern fn list_clone(list: [*c]List, cloned_element: ?*const fn (?*anyopaque) callconv(.C) ?*anyopaque) [*c]List;
pub extern fn list_head(list: [*c]List) ?*anyopaque;
pub extern fn list_join_to_string(list: [*c]List, delimiter: ?*anyopaque, prefix: ?*anyopaque, postfix: ?*anyopaque, useX: bool) [*c]XString;
pub extern fn list_iterator_from(list: [*c]List) ListIterator;
pub extern fn list_iterator_has_next(iterator: [*c]ListIterator) bool;
pub extern fn list_iterator_next(iterator: [*c]ListIterator) ?*anyopaque;
pub const Number: c_int = 0;
pub const Error: c_int = 1;
pub const Symbol: c_int = 2;
pub const SExpression: c_int = 3;
pub const QExpression: c_int = 4;
pub const LispType = c_uint;
...
pub const struct_LispValue = extern struct {
    type: LispType,
    unnamed_0: union_unnamed_1,
};
pub const LispValue = struct_LispValue;
pub extern fn number_from(number: c_int) [*c]LispValue;
pub extern fn error_from(@"error": [*c]XString) [*c]LispValue;
pub extern fn symbol_from(symbol: [*c]XString) [*c]LispValue;
pub extern fn expressions_new(@"type": LispType) [*c]LispValue;
pub extern fn lisp_value_drop(value: [*c]LispValue) void;
pub extern fn lisp_value_to_string(value: [*c]LispValue) [*c]XString;
pub extern fn lisp_value_add_cell(value: [*c]LispValue, cell: [*c]LispValue) void;
pub extern fn lisp_value_clone(value: [*c]LispValue) [*c]LispValue;
pub extern fn eval_built_in_functions(function_name: [*c]const u8, args: [*c]List) [*c]LispValue;
...
const struct_unnamed_2 = opaque {}; // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/wait.h:220:19: warning: struct demoted to opaque type - has bitfield
...
pub extern fn arc4random_uniform(__upper_bound: u32) u32; // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/stdlib.h:268:6: warning: unsupported type: 'BlockPointer'
pub const atexit_b = @compileError("unable to resolve prototype of function"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/stdlib.h:268:6
// /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/stdlib.h:277:7: warning: unsupported type: 'BlockPointer'
pub const bsearch_b = @compileError("unable to resolve prototype of function"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/stdlib.h:277:7
...
pub extern fn heapsort(__base: ?*anyopaque, __nel: usize, __width: usize, __compar: ?*const fn (?*const anyopaque, ?*const anyopaque) callconv(.C) c_int) c_int; // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/stdlib.h:314:6: warning: unsupported type: 'BlockPointer'
pub const heapsort_b = @compileError("unable to resolve prototype of function"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/stdlib.h:314:6
pub extern fn mergesort(__base: ?*anyopaque, __nel: usize, __width: usize, __compar: ?*const fn (?*const anyopaque, ?*const anyopaque) callconv(.C) c_int) c_int; // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/stdlib.h:321:6: warning: unsupported type: 'BlockPointer'
pub const mergesort_b = @compileError("unable to resolve prototype of function"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/stdlib.h:321:6
pub extern fn psort(__base: ?*anyopaque, __nel: usize, __width: usize, __compar: ?*const fn (?*const anyopaque, ?*const anyopaque) callconv(.C) c_int) void; // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/stdlib.h:329:7: warning: unsupported type: 'BlockPointer'
pub const psort_b = @compileError("unable to resolve prototype of function"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/stdlib.h:329:7
pub extern fn psort_r(__base: ?*anyopaque, __nel: usize, __width: usize, ?*anyopaque, __compar: ?*const fn (?*anyopaque, ?*const anyopaque, ?*const anyopaque) callconv(.C) c_int) void; // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/stdlib.h:337:7: warning: unsupported type: 'BlockPointer'
pub const qsort_b = @compileError("unable to resolve prototype of function"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/stdlib.h:337:7
...
pub extern fn mpc_check(a: ?*mpc_parser_t, f: mpc_check_t, e: [*c]const u8) ?*mpc_parser_t;
pub extern fn mpc_check_with(a: ?*mpc_parser_t, f: mpc_check_with_t, x: ?*anyopaque, e: [*c]const u8) ?*mpc_parser_t;
pub extern fn mpc_checkf(a: ?*mpc_parser_t, f: mpc_check_t, fmt: [*c]const u8, ...) ?*mpc_parser_t;
pub extern fn mpc_check_withf(a: ?*mpc_parser_t, f: mpc_check_with_t, x: ?*anyopaque, fmt: [*c]const u8, ...) ?*mpc_parser_t;
...
pub extern fn mpcf_maths(n: c_int, xs: [*c]?*mpc_val_t) ?*mpc_val_t;
...
pub extern fn string_equals(a: [*c]const u8, b: [*c]const u8) bool;
pub export fn read_all(arg_node: [*c]mpc_ast_t) [*c]List {
    var node = arg_node;
    var values: [*c]List = list_new();
    {
        var i: c_int = 1;
        while (i < (node.*.children_num - @as(c_int, 1))) : (i += 1) {
            _ = list_push(values, @as(?*anyopaque, @ptrCast(read((blk: {
                const tmp = i;
                if (tmp >= 0) break :blk node.*.children + @as(usize, @intCast(tmp)) else break :blk node.*.children - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*))));
        }
    }
    return values;
}
pub export fn eval(arg_value: [*c]LispValue) [*c]LispValue {
    var value = arg_value;
    if (value.*.type == @as(c_uint, @bitCast(SExpression))) {
        if (value.*.unnamed_0.expressions.*.size == @as(usize, @bitCast(@as(c_long, @as(c_int, 0))))) {
            return error_from(xstring_from("empty expression"));
        }
        var iterator: ListIterator = list_iterator_from(value.*.unnamed_0.expressions);
        var operator: [*c]LispValue = @as([*c]LispValue, @ptrCast(@alignCast(list_iterator_next(&iterator))));
        var has_eval: bool = @as(c_int, 0) != 0;
        if ((operator.*.type == @as(c_uint, @bitCast(SExpression))) and (@as(c_int, @intFromBool(string_equals(xstring_to_c_string(@as([*c]LispValue, @ptrCast(@alignCast(list_head(operator.*.unnamed_0.expressions)))).*.unnamed_0.symbol), "eval"))) != 0)) {
            operator = eval(@as([*c]LispValue, @ptrCast(@alignCast(list_get(operator.*.unnamed_0.expressions, @as(usize, @bitCast(@as(c_long, @as(c_int, 1)))))))));
            has_eval = @as(c_int, 1) != 0;
        }
        if (operator.*.type != @as(c_uint, @bitCast(Symbol))) {
            return error_from(xstring_from("not a function"));
        }
        var args: [*c]List = list_new_with_capacity(value.*.unnamed_0.expressions.*.size -% @as(usize, @bitCast(@as(c_long, @as(c_int, 1)))));
        while (list_iterator_has_next(&iterator)) {
            _ = list_push(args, @as(?*anyopaque, @ptrCast(eval(@as([*c]LispValue, @ptrCast(@alignCast(list_iterator_next(&iterator))))))));
        }
        var result: [*c]LispValue = eval_built_in_functions(xstring_to_c_string(operator.*.unnamed_0.symbol), args);
        list_drop(args, @as(?*const fn (?*anyopaque) callconv(.C) void, @ptrCast(@alignCast(&lisp_value_drop))));
        if (has_eval) {
...
pub extern fn eval_operation(operator: [*c]const u8, args: [*c]List) [*c]LispValue;
pub export fn main() c_int {
    var number: ?*mpc_parser_t = mpc_new("number");
    var symbol: ?*mpc_parser_t = mpc_new("symbol");
    var expression: ?*mpc_parser_t = mpc_new("expression");
    var s_expression: ?*mpc_parser_t = mpc_new("s_expression");
    var q_expression: ?*mpc_parser_t = mpc_new("q_expression");
    var lispy: ?*mpc_parser_t = mpc_new("lispy");
    _ = mpca_lang(MPCA_LANG_DEFAULT, "                                                                    number      : /-?[0-9]+/;                                                  symbol      : '+' | '-' | '*' | '/'                                                    | \"eval\" | \"list\" | \"head\";                              expression  : <number> | <symbol> | <s_expression> | <q_expression>;       s_expression: '(' <expression>* ')';                                       q_expression: '{' <expression>* '}';                                       lispy       : /^/ <expression>* /$/;                                     ", number, symbol, expression, s_expression, q_expression, lispy);
    while (true) {
        var input: [*c]u8 = readline("lispy> ");
        _ = add_history(input);
        if ((input == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @intFromBool(string_equals(input, "exit"))) != 0)) {
            free(@as(?*anyopaque, @ptrCast(input)));
            break;
        }
        var result: mpc_result_t = undefined;
        if (mpc_parse("<stdin>", input, lispy, &result) != 0) {
            var values: [*c]List = read_all(@as([*c]mpc_ast_t, @ptrCast(@alignCast(result.output))));
            {
                var i: usize = 0;
                var j: usize = 0;
                while (i < values.*.size) : (i +%= 1) {
                    var value: [*c]LispValue = @as([*c]LispValue, @ptrCast(@alignCast(list_get(values, i))));
                    while (i == j) : (j +%= 1) {
                        while (true) {
                            switch (value.*.type) {
                                @as(c_uint, @bitCast(@as(c_int, 0))), @as(c_uint, @bitCast(@as(c_int, 1))), @as(c_uint, @bitCast(@as(c_int, 2))), @as(c_uint, @bitCast(@as(c_int, 4))) => {
                                    {
                                        var s: [*c]XString = lisp_value_to_string(value);
                                        _ = printf("%s ", xstring_to_c_string(s));
                                        xstring_drop(s);
                                        break;
                                    }
                                },
                                @as(c_uint, @bitCast(@as(c_int, 3))) => {
                                    {
                                        var r: [*c]LispValue = eval(value);
                                        var s: [*c]XString = lisp_value_to_string(r);
                                        _ = printf("%s ", xstring_to_c_string(s));
                                        xstring_drop(s);
                                        lisp_value_drop(r);
                                        break;
            ...
            _ = putchar(@as(c_int, '\n'));
            list_drop(values, @as(?*const fn (?*anyopaque) callconv(.C) void, @ptrCast(@alignCast(&lisp_value_drop))));
            mpc_ast_delete(@as([*c]mpc_ast_t, @ptrCast(@alignCast(result.output))));
        } else {
    ...
    mpc_cleanup(@as(c_int, 6), number, symbol, expression, s_expression, q_expression, lispy);
    return 0;
}
pub export fn read(arg_node: [*c]mpc_ast_t) [*c]LispValue {
    var node = arg_node;
    if (strstr(node.*.tag, "number") != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        __error().* = 0;
        var number: c_int = @as(c_int, @bitCast(@as(c_int, @truncate(strtol(node.*.contents, null, @as(c_int, 10))))));
        return if (__error().* == @as(c_int, 34)) error_from(xstring_from("invalid number")) else number_from(number);
    }
    if (strstr(node.*.tag, "symbol") != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        return symbol_from(xstring_from(node.*.contents));
    }
    {
        var is_s_expression: bool = strstr(node.*.tag, "s_expression") != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))));
        var is_q_expression: bool = strstr(node.*.tag, "q_expression") != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))));
        if ((@as(c_int, @intFromBool(is_s_expression)) != 0) or (@as(c_int, @intFromBool(is_q_expression)) != 0)) {
            var value: [*c]LispValue = expressions_new(@as(c_uint, @bitCast(if (@as(c_int, @intFromBool(is_s_expression)) != 0) SExpression else QExpression)));
            {
                var i: c_int = 1;
                while (i < (node.*.children_num - @as(c_int, 1))) : (i += 1) {
                    lisp_value_add_cell(value, read((blk: {
                        const tmp = i;
                        if (tmp >= 0) break :blk node.*.children + @as(usize, @intCast(tmp)) else break :blk node.*.children - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*));
                }
...
pub const __exported = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:190:9
pub const __exported_push = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:191:9
pub const __exported_pop = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:192:9
pub const __deprecated = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:204:9
pub const __deprecated_msg = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:208:10
pub const __kpi_deprecated = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:219:9
pub const __unavailable = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:225:9
pub const __restrict = @compileError("unable to translate C expr: unexpected token 'restrict'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:247:9
pub const __disable_tail_calls = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:280:9
pub const __not_tail_called = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:292:9
pub const __result_use_check = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:303:9
pub const __swift_unavailable = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:313:9
pub const __header_inline = @compileError("unable to translate C expr: unexpected token 'inline'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:347:10
pub const __header_always_inline = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:360:10
pub const __unreachable_ok_push = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:373:10
pub const __unreachable_ok_pop = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:376:10
pub const __printflike = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:397:9
pub const __printf0like = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:399:9
pub const __scanflike = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:401:9
pub const __osloglike = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:403:9
pub const __IDSTRING = @compileError("unable to translate C expr: unexpected token 'static'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:406:9
pub const __COPYRIGHT = @compileError("unable to translate macro: undefined identifier `copyright`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:409:9
pub const __RCSID = @compileError("unable to translate macro: undefined identifier `rcsid`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:413:9
pub const __SCCSID = @compileError("unable to translate macro: undefined identifier `sccsid`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:417:9
pub const __PROJECT_VERSION = @compileError("unable to translate macro: undefined identifier `project_version`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:421:9
pub const __FBSDID = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:426:9
pub const __DECONST = @compileError("unable to translate C expr: unexpected token 'const'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:430:9
pub const __DEVOLATILE = @compileError("unable to translate C expr: unexpected token 'volatile'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:434:9
pub const __DEQUALIFY = @compileError("unable to translate C expr: unexpected token 'const'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:438:9
pub const __alloc_size = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:456:9
pub const __DARWIN_ALIAS = @compileError("unable to translate macro: undefined identifier `__asm`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:641:9
pub const __DARWIN_ALIAS_C = @compileError("unable to translate macro: undefined identifier `__asm`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:642:9
pub const __DARWIN_ALIAS_I = @compileError("unable to translate macro: undefined identifier `__asm`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:643:9
pub const __DARWIN_NOCANCEL = @compileError("unable to translate macro: undefined identifier `__asm`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:644:9
pub const __DARWIN_INODE64 = @compileError("unable to translate macro: undefined identifier `__asm`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:645:9
pub const __DARWIN_1050 = @compileError("unable to translate macro: undefined identifier `__asm`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:647:9
pub const __DARWIN_1050ALIAS = @compileError("unable to translate macro: undefined identifier `__asm`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:648:9
pub const __DARWIN_1050ALIAS_C = @compileError("unable to translate macro: undefined identifier `__asm`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:649:9
pub const __DARWIN_1050ALIAS_I = @compileError("unable to translate macro: undefined identifier `__asm`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:650:9
pub const __DARWIN_1050INODE64 = @compileError("unable to translate macro: undefined identifier `__asm`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:651:9
pub const __DARWIN_EXTSN = @compileError("unable to translate macro: undefined identifier `__asm`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:653:9
pub const __DARWIN_EXTSN_C = @compileError("unable to translate macro: undefined identifier `__asm`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:654:9
...
pub const __DARWIN_ALIAS_STARTING = @compileError("unable to translate macro: undefined identifier `__DARWIN_ALIAS_STARTING_MAC_`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:664:9
pub const __POSIX_C_DEPRECATED = @compileError("unable to translate macro: undefined identifier `___POSIX_C_DEPRECATED_STARTING_`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:727:9
pub const __XNU_PRIVATE_EXTERN = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:827:9
pub const __counted_by = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:841:9
pub const __sized_by = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:842:9
pub const __ended_by = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:843:9
pub const __ptrcheck_abi_assume_single = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:852:9
pub const __ptrcheck_abi_assume_unsafe_indexable = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:853:9
pub const __compiler_barrier = @compileError("unable to translate macro: undefined identifier `__asm__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:887:9
pub const __enum_open = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:890:9
pub const __enum_closed = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:891:9
pub const __enum_options = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:898:9
pub const __enum_decl = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:911:9
pub const __enum_closed_decl = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:913:9
pub const __options_decl = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:915:9
pub const __options_closed_decl = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/cdefs.h:917:9
...
pub const __API_A = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4460:17
pub const __API_AVAILABLE2 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4469:13
pub const __API_AVAILABLE3 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4470:13
pub const __API_AVAILABLE4 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4471:13
pub const __API_AVAILABLE5 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4472:13
pub const __API_AVAILABLE6 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4473:13
pub const __API_AVAILABLE7 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4474:13
pub const __API_AVAILABLE_GET_MACRO = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4475:13
pub const __API_APPLY_TO = @compileError("unable to translate macro: undefined identifier `any`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4477:13
pub const __API_RANGE_STRINGIFY2 = @compileError("unable to translate C expr: unexpected token '#'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4479:13
pub const __API_A_BEGIN = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4481:13
pub const __API_AVAILABLE_BEGIN2 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4484:13
pub const __API_AVAILABLE_BEGIN3 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4485:13
pub const __API_AVAILABLE_BEGIN4 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4486:13
pub const __API_AVAILABLE_BEGIN5 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4487:13
pub const __API_AVAILABLE_BEGIN6 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4488:13
pub const __API_AVAILABLE_BEGIN7 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4489:13
pub const __API_AVAILABLE_BEGIN_GET_MACRO = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4490:13
pub const __API_DEPRECATED_PLATFORM_macos = @compileError("unable to translate macro: undefined identifier `macos`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4493:13
pub const __API_DEPRECATED_PLATFORM_macosx = @compileError("unable to translate macro: undefined identifier `macosx`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4494:13
pub const __API_DEPRECATED_PLATFORM_ios = @compileError("unable to translate macro: undefined identifier `ios`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4495:13
pub const __API_DEPRECATED_PLATFORM_watchos = @compileError("unable to translate macro: undefined identifier `watchos`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4496:13
pub const __API_DEPRECATED_PLATFORM_tvos = @compileError("unable to translate macro: undefined identifier `tvos`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4497:13
pub const __API_DEPRECATED_PLATFORM_macCatalyst = @compileError("unable to translate macro: undefined identifier `macCatalyst`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4499:13
pub const __API_DEPRECATED_PLATFORM_uikitformac = @compileError("unable to translate macro: undefined identifier `uikitformac`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4502:14
pub const __API_DEPRECATED_PLATFORM_driverkit = @compileError("unable to translate macro: undefined identifier `driverkit`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4504:13
pub const __API_D = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4508:17
pub const __API_DEPRECATED_MSG3 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4517:13
pub const __API_DEPRECATED_MSG4 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4518:13
pub const __API_DEPRECATED_MSG5 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4519:13
pub const __API_DEPRECATED_MSG6 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4520:13
pub const __API_DEPRECATED_MSG7 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4521:13
pub const __API_DEPRECATED_MSG8 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4522:13
pub const __API_DEPRECATED_MSG_GET_MACRO = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4523:13
pub const __API_D_BEGIN = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4525:13
pub const __API_DEPRECATED_BEGIN_MSG3 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4528:13
pub const __API_DEPRECATED_BEGIN_MSG4 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4529:13
pub const __API_DEPRECATED_BEGIN_MSG5 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4530:13
pub const __API_DEPRECATED_BEGIN_MSG6 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4531:13
pub const __API_DEPRECATED_BEGIN_MSG7 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4532:13
pub const __API_DEPRECATED_BEGIN_MSG8 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4533:13
pub const __API_DEPRECATED_BEGIN_MSG_GET_MACRO = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4534:13
pub const __API_R = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4537:17
pub const __API_DEPRECATED_REP3 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4543:13
pub const __API_DEPRECATED_REP4 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4544:13
pub const __API_DEPRECATED_REP5 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4545:13
pub const __API_DEPRECATED_REP6 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4546:13
pub const __API_DEPRECATED_REP7 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4547:13
pub const __API_DEPRECATED_REP8 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4548:13
pub const __API_DEPRECATED_REP_GET_MACRO = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4549:13
pub const __API_R_BEGIN = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4552:17
pub const __API_DEPRECATED_BEGIN_REP3 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4558:13
pub const __API_DEPRECATED_BEGIN_REP4 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4559:13
pub const __API_DEPRECATED_BEGIN_REP5 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4560:13
pub const __API_DEPRECATED_BEGIN_REP6 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4561:13
pub const __API_DEPRECATED_BEGIN_REP7 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4562:13
pub const __API_DEPRECATED_BEGIN_REP8 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4563:13
pub const __API_DEPRECATED_BEGIN_REP_GET_MACRO = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4564:13
pub const __API_UNAVAILABLE_PLATFORM_macos = @compileError("unable to translate macro: undefined identifier `macos`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4574:13
pub const __API_UNAVAILABLE_PLATFORM_macosx = @compileError("unable to translate macro: undefined identifier `macosx`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4575:13
pub const __API_UNAVAILABLE_PLATFORM_ios = @compileError("unable to translate macro: undefined identifier `ios`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4576:13
pub const __API_UNAVAILABLE_PLATFORM_watchos = @compileError("unable to translate macro: undefined identifier `watchos`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4577:13
pub const __API_UNAVAILABLE_PLATFORM_tvos = @compileError("unable to translate macro: undefined identifier `tvos`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4578:13
pub const __API_UNAVAILABLE_PLATFORM_macCatalyst = @compileError("unable to translate macro: undefined identifier `macCatalyst`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4580:13
pub const __API_UNAVAILABLE_PLATFORM_uikitformac = @compileError("unable to translate macro: undefined identifier `uikitformac`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4583:14
pub const __API_UNAVAILABLE_PLATFORM_driverkit = @compileError("unable to translate macro: undefined identifier `driverkit`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4585:13
pub const __API_U = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4589:17
pub const __API_UNAVAILABLE2 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4598:13
pub const __API_UNAVAILABLE3 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4599:13
pub const __API_UNAVAILABLE4 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4600:13
pub const __API_UNAVAILABLE5 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4601:13
pub const __API_UNAVAILABLE6 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4602:13
pub const __API_UNAVAILABLE7 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4603:13
pub const __API_UNAVAILABLE_GET_MACRO = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4604:13
pub const __API_U_BEGIN = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4606:13
pub const __API_UNAVAILABLE_BEGIN2 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4609:13
pub const __API_UNAVAILABLE_BEGIN3 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4610:13
pub const __API_UNAVAILABLE_BEGIN4 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4611:13
pub const __API_UNAVAILABLE_BEGIN5 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4612:13
pub const __API_UNAVAILABLE_BEGIN6 = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4613:13
pub const __API_UNAVAILABLE_BEGIN7 = @compileError("unable to translate macro: undefined identifier `g`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4614:13
pub const __API_UNAVAILABLE_BEGIN_GET_MACRO = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4615:13
pub const __swift_compiler_version_at_least = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4664:13
pub const __SPI_AVAILABLE = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/AvailabilityInternal.h:4672:11
pub const __OSX_AVAILABLE_STARTING = @compileError("unable to translate macro: undefined identifier `__AVAILABILITY_INTERNAL`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:172:17
pub const __OSX_AVAILABLE_BUT_DEPRECATED = @compileError("unable to translate macro: undefined identifier `__AVAILABILITY_INTERNAL`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:173:17
pub const __OSX_AVAILABLE_BUT_DEPRECATED_MSG = @compileError("unable to translate macro: undefined identifier `__AVAILABILITY_INTERNAL`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:175:17
pub const __OS_AVAILABILITY = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:198:13
pub const __OS_AVAILABILITY_MSG = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:199:13
pub const __OSX_EXTENSION_UNAVAILABLE = @compileError("unable to translate macro: undefined identifier `macosx_app_extension`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:216:13
pub const __IOS_EXTENSION_UNAVAILABLE = @compileError("unable to translate macro: undefined identifier `ios_app_extension`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:217:13
pub const __OS_EXTENSION_UNAVAILABLE = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:227:9
pub const __OSX_UNAVAILABLE = @compileError("unable to translate macro: undefined identifier `macosx`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:234:13
pub const __OSX_AVAILABLE = @compileError("unable to translate macro: undefined identifier `macosx`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:235:13
pub const __OSX_DEPRECATED = @compileError("unable to translate macro: undefined identifier `macosx`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:236:13
pub const __IOS_UNAVAILABLE = @compileError("unable to translate macro: undefined identifier `ios`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:256:13
pub const __IOS_PROHIBITED = @compileError("unable to translate macro: undefined identifier `ios`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:257:13
pub const __IOS_AVAILABLE = @compileError("unable to translate macro: undefined identifier `ios`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:258:13
pub const __IOS_DEPRECATED = @compileError("unable to translate macro: undefined identifier `ios`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:259:13
pub const __TVOS_UNAVAILABLE = @compileError("unable to translate macro: undefined identifier `tvos`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:283:13
pub const __TVOS_PROHIBITED = @compileError("unable to translate macro: undefined identifier `tvos`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:284:13
pub const __TVOS_AVAILABLE = @compileError("unable to translate macro: undefined identifier `tvos`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:285:13
pub const __TVOS_DEPRECATED = @compileError("unable to translate macro: undefined identifier `tvos`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:286:13
pub const __WATCHOS_UNAVAILABLE = @compileError("unable to translate macro: undefined identifier `watchos`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:310:13
pub const __WATCHOS_PROHIBITED = @compileError("unable to translate macro: undefined identifier `watchos`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:311:13
pub const __WATCHOS_AVAILABLE = @compileError("unable to translate macro: undefined identifier `watchos`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:312:13
pub const __WATCHOS_DEPRECATED = @compileError("unable to translate macro: undefined identifier `watchos`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:313:13
pub const __SWIFT_UNAVAILABLE = @compileError("unable to translate macro: undefined identifier `swift`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:337:13
pub const __SWIFT_UNAVAILABLE_MSG = @compileError("unable to translate macro: undefined identifier `swift`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:338:13
pub const __API_AVAILABLE = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:381:13
pub const __API_AVAILABLE_BEGIN = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:383:13
pub const __API_AVAILABLE_END = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:384:13
pub const __API_DEPRECATED = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:402:13
pub const __API_DEPRECATED_WITH_REPLACEMENT = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:403:13
pub const __API_DEPRECATED_BEGIN = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:405:13
pub const __API_DEPRECATED_END = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:406:13
pub const __API_DEPRECATED_WITH_REPLACEMENT_BEGIN = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:408:13
pub const __API_DEPRECATED_WITH_REPLACEMENT_END = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:409:13
pub const __API_UNAVAILABLE = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:419:13
pub const __API_UNAVAILABLE_BEGIN = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:421:13
pub const __API_UNAVAILABLE_END = @compileError("unable to translate macro: undefined identifier `_Pragma`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:422:13
pub const __SPI_DEPRECATED = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:475:11
pub const __SPI_DEPRECATED_WITH_REPLACEMENT = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/Availability.h:479:11
...
pub const __sgetc = @compileError("TODO unary inc/dec expr"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/stdio.h:251:9
pub const __sclearerr = @compileError("unable to translate C expr: expected ')' instead got '&='"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/stdio.h:275:9
pub const TIOCGETA = @compileError("unable to translate macro: undefined identifier `termios`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/ttycom.h:108:9
pub const TIOCSETA = @compileError("unable to translate macro: undefined identifier `termios`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/ttycom.h:109:9
pub const TIOCSETAW = @compileError("unable to translate macro: undefined identifier `termios`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/ttycom.h:110:9
pub const TIOCSETAF = @compileError("unable to translate macro: undefined identifier `termios`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/ttycom.h:111:9
pub const SIOCSIFADDR = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:83:9
pub const SIOCSIFDSTADDR = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:84:9
pub const SIOCSIFFLAGS = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:85:9
pub const SIOCGIFFLAGS = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:86:9
pub const SIOCSIFBRDADDR = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:87:9
pub const SIOCSIFNETMASK = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:88:9
pub const SIOCGIFMETRIC = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:89:9
pub const SIOCSIFMETRIC = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:90:9
pub const SIOCDIFADDR = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:91:9
pub const SIOCAIFADDR = @compileError("unable to translate macro: undefined identifier `ifaliasreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:92:9
pub const SIOCGIFADDR = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:94:9
pub const SIOCGIFDSTADDR = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:95:9
pub const SIOCGIFBRDADDR = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:96:9
pub const SIOCGIFCONF = @compileError("unable to translate macro: undefined identifier `ifconf`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:97:9
pub const SIOCGIFNETMASK = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:98:9
pub const SIOCAUTOADDR = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:99:9
pub const SIOCAUTONETMASK = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:100:9
pub const SIOCARPIPLL = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:101:9
pub const SIOCADDMULTI = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:103:9
pub const SIOCDELMULTI = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:104:9
pub const SIOCGIFMTU = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:105:9
pub const SIOCSIFMTU = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:106:9
pub const SIOCGIFPHYS = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:107:9
pub const SIOCSIFPHYS = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:108:9
pub const SIOCSIFMEDIA = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:109:9
pub const SIOCGIFMEDIA = @compileError("unable to translate macro: undefined identifier `ifmediareq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:115:9
pub const SIOCSIFGENERIC = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:117:9
pub const SIOCGIFGENERIC = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:118:9
pub const SIOCRSLVMULTI = @compileError("unable to translate macro: undefined identifier `rslvmulti_req`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:119:9
pub const SIOCSIFLLADDR = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:121:9
pub const SIOCGIFSTATUS = @compileError("unable to translate macro: undefined identifier `ifstat`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:122:9
pub const SIOCSIFPHYADDR = @compileError("unable to translate macro: undefined identifier `ifaliasreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:123:9
pub const SIOCGIFPSRCADDR = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:124:9
pub const SIOCGIFPDSTADDR = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:125:9
pub const SIOCDIFPHYADDR = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:126:9
pub const SIOCGIFDEVMTU = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:128:9
pub const SIOCSIFALTMTU = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:129:9
pub const SIOCGIFALTMTU = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:130:9
pub const SIOCSIFBOND = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:131:9
pub const SIOCGIFBOND = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:132:9
pub const SIOCGIFXMEDIA = @compileError("unable to translate macro: undefined identifier `ifmediareq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:141:9
pub const SIOCSIFCAP = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:144:9
pub const SIOCGIFCAP = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:145:9
pub const SIOCIFCREATE = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:147:9
pub const SIOCIFDESTROY = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:148:9
pub const SIOCIFCREATE2 = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:149:9
pub const SIOCSDRVSPEC = @compileError("unable to translate macro: undefined identifier `ifdrv`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:151:9
pub const SIOCGDRVSPEC = @compileError("unable to translate macro: undefined identifier `ifdrv`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:153:9
pub const SIOCSIFVLAN = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:155:9
pub const SIOCGIFVLAN = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:156:9
pub const SIOCIFGCLONERS = @compileError("unable to translate macro: undefined identifier `if_clonereq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:160:9
pub const SIOCGIFASYNCMAP = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:162:9
pub const SIOCSIFASYNCMAP = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:163:9
pub const SIOCGIFMAC = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:167:9
pub const SIOCSIFMAC = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:168:9
pub const SIOCSIFKPI = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:169:9
pub const SIOCGIFKPI = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:170:9
pub const SIOCGIFWAKEFLAGS = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:172:9
pub const SIOCGIFFUNCTIONALTYPE = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:174:9
pub const SIOCSIF6LOWPAN = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:176:9
pub const SIOCGIF6LOWPAN = @compileError("unable to translate macro: undefined identifier `ifreq`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/sockio.h:177:9
pub const TTYDEF_IFLAG = @compileError("unable to translate macro: undefined identifier `BRKINT`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/ttydefaults.h:78:9
pub const TTYDEF_OFLAG = @compileError("unable to translate macro: undefined identifier `OPOST`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/ttydefaults.h:79:9
pub const TTYDEF_LFLAG = @compileError("unable to translate macro: undefined identifier `ECHO`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/ttydefaults.h:80:9
pub const TTYDEF_CFLAG = @compileError("unable to translate macro: undefined identifier `CREAD`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/ttydefaults.h:81:9
pub const TTYDEF_SPEED = @compileError("unable to translate macro: undefined identifier `B9600`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/ttydefaults.h:82:9
...
pub const for_each = @compileError("unable to translate macro: undefined identifier `i`"); // ./lib/list.h:39:9
...
pub const __darwin_arm_thread_state64_set_pc_fptr = @compileError("unable to translate C expr: expected ')' instead got '='"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/mach/arm/_structs.h:362:9
pub const __darwin_arm_thread_state64_set_lr_fptr = @compileError("unable to translate C expr: expected ')' instead got '='"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/mach/arm/_structs.h:371:9
pub const __darwin_arm_thread_state64_set_sp = @compileError("unable to translate C expr: expected ')' instead got '='"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/mach/arm/_structs.h:377:9
pub const __darwin_arm_thread_state64_set_fp = @compileError("unable to translate C expr: expected ')' instead got '='"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/mach/arm/_structs.h:383:9
...
pub const __bsearch_noescape = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/stdlib.h:272:9
pub const __sort_noescape = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/stdlib.h:305:9
...
pub const __ENVIRONMENT_MAC_OS_X_VERSION_MIN_REQUIRED__ = @import("std").zig.c_translation.promoteIntLiteral(c_int, 120700, .decimal);
...
pub const BuiltInFunctionsHeader = "";
pub const LispValueHeader = "";
pub const ListHeader = "";
